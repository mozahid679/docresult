...
<li>
    <a href="{{ $href }}" @class([
        ...
        <span class="ml-3 whitespace-nowrap" x-show="sidebarOpen" x-transition:enter="transition-all duration-300"
            ...
            x-transition:leave-end="opacity-0 transform -translate-x-2">{{ $slot }}</span>
    </a>
</li>
